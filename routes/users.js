...
const { createShippingAddress, updateShippingAdress, deleteShippingAddress, setDefaultAddress, getUserAddresses } = require('../controller/user_address.js');
...
router.get('/user-adresses', auth, getUserAddresses)
